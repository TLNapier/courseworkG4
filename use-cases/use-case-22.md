# USE CASE 1 : Produce a report on the top N populated capital cities in a region where N is provided by the user 
...
1. Organisation is asked for a report on the top N populated capital cities in a region where N is provided by the user.
